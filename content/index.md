...
> [!info] Start here
> - **[[catalog]]** — every paper summary, indexed.
> - **[[log]]** — changelog of what the wiki agent has done.
...
The agent verifies the paper, writes a 15-section summary, and wires it into the [[catalog]], [[log]], and related concept/topic/entity pages. Unverifiable requests go to [[unresolved-paper-requests]] — never guessed.
