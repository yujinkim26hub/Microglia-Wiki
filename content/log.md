...
- **2026-06-03** — Updated [[catalog|Catalog]] with the three papers (table + by-topic + by-disease).
...
- **2026-06-03** — Initialized the wiki: created folder structure, [[index]], [[catalog|Catalog]], seed concept/entity/topic pages, templates, and the paper-ingestion workflow. No papers ingested yet.
